...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <legend class="text-gray-800 font-bold text-m mt-2 mb-3">Estado de Publicación</legend>

        <input id="publico" class="peer/publico" type="radio" name="estado" checked>
        <label for="publico" class="peer-checked/publico:text-sky-500 font-bold">
            Público
        </label>

        <input id="privado" class="peer/privado" type="radio" name="estado" checked>
